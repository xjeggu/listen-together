...
export namespace Popup {
  ...
  export class Textbox extends React.Component<TextboxProps, {}> {
    ...
    render() {
      return (
        <tr>
          <td style={{ paddingBottom: this.props.bottomSpace || 20 }}>
    ...
    render() {
      return (
        <tr>
          <td
            colSpan={2}
            style={{ paddingBottom: this.props.bottomSpace || 20 }}
          >
            <div style={this.props.centered || true ? styles.center : {}}>
              {this.props.text}
            </div>
          </td>
        </tr>
    ...
    render() {
      return (
        <tr>
          <td
            colSpan={2}
            style={{ paddingBottom: this.props.bottomSpace || 10 }}
          >
            <button
              className="lt-popup-button"
              onClick={() => {
                if (this.props.onClick) this.props.onClick();
              }}
              disabled={this.props.disabled}
            >
              <span className="lt-popup-text" dir="auto">
                {this.props.text}
              </span>
            </button>
          </td>
                    ...
                    <table style={{ width: '100%' }}>
                      <tr>
                        {buttons.map((btn) => {
                          return (
                            <td>
                              <div style={styles.center}>{btn}</div>
                            </td>
                          );
                        })}
                      </tr>
